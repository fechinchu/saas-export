...
<head>
    ...
    <script type="text/javascript">
        ...
        var submitCheckedNodes = function () {
            ...
            $("#moduleIds").val(str.substr(0,str.length-1));
            $("#formId").submit();
        };
       ...
       // var code;
        ...
        $(function () {
            //alert("呵呵");
            $.ajax({
                url:"${pageContext.request.contextPath}/system/role/getZtreeNodes.do",
                data:"roleid=${role.id}",
                type:"POST",
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="table-box">
                    ...
                    <!--工具栏/-->
                    <!-- 树菜单 -->
                    <form name="icform" method="post" id="formId" action="/system/role/updateRoleModule.do">
