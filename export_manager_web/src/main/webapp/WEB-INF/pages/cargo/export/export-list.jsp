            ...
            <div class="box-body">
                ...
                <div class="table-box">
                    ...
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default" title="装箱"
                                        onclick="document.getElementById('exportForm').submit()"><i
                                        class="fa fa-refresh"></i>装箱
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                        ...
                        <tbody>
                        <form id="exportForm" action="/cargo/packing/packing.do" method="post">
                            <c:forEach items="${page.list}" var="o" varStatus="status">
                                <tr class="odd" onmouseover="this.className='highlight'"
                                    onmouseout="this.className='odd'">
                                    <td><input type="checkbox" name="id" value="${o.id}"  ${o.state==3?"disabled":""}  /></td>
                                    <td>${o.id}</td>
                                    <td align="center">
                                            ${o.proNum}/${o.extNum}
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <c:if test="${o.state==3}"><font color="#8a2be2">已装箱</font></c:if>
                                    </td>
                                    <td>
